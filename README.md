...
- **Scripts & dev config** (`scripts/`, `.devcontainer/`) — GPL-3.0 · see [`LICENSE-CODE`](LICENSE-CODE) — kept GPL-3.0 to stay license-compatible with the MeshBee code repos they serve
