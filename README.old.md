> ⚠️ **This is the old README, kept for reference only.**
> It may be out of date. See the current [`README.md`](README.md) for the up-to-date overview,
> and the [documentation site](https://fablab-imperia.github.io/meshbee/) for the full docs.
